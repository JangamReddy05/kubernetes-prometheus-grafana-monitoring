...
│
├── dashboards/
│   └── kubernetes-app-dashboard.json
│
├── screenshots/
│   ├── 01-project-structure.png
│   ├── 02-cluster-running.png
│   ├── 03-monitoring-pods.png
│   ├── 04-application-running.png
│   ├── 05-application-metrics.png
│   ├── 06-prometheus-target-up.png
│   ├── 07-promql-query.png
│   ├── 08-grafana-dashboard.png
│   ├── 09-alert-firing.png
│   ├── 10-application-recovered.png
│   ├── 11-self-healing.png
│   └── 12-recovery-dashboard.png
│
└── docs/
    └── architecture.md
...
## Author
**JangamReddy05**
Kubernetes | Docker | Helm | Prometheus | Grafana | Azure DevOps | Cloud & DevOps
